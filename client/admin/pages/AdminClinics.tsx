                ...
                {isSuperAdmin ? (
                  <>
                    {clinic.subscription_status === "inactive" ? (
                      <Button size="sm" variant="outline" onClick={() => setClinicStatus(clinic.id, "active")} disabled={loading}>
                        Reactivate
                      </Button>
                    ) : (
                      <Button size="sm" variant="outline" onClick={() => setClinicStatus(clinic.id, "inactive")} disabled={loading}>
                        Suspend
                      </Button>
                    )}
